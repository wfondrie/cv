...
\begin{tabular}{\tdim}
  2021     & \textbf{UW eScience Postdoctoral Fellow Research Funds Award} \\
...
\mysection{Preprints}
\begin{etaremune}
  \item \textbf{Fondrie WE}, Bittremieux W, Noble WS. (2021) ppx: Programmatic
  access to proteomics data repositories. \textit{bioRxiv}. DOI:
...
\begin{etaremune}
  ...
  \item \textbf{ppx}. A Python package to retrieve metadata and files for
...
\begin{etaremune}
  ...
  %\item \textbf{Fondrie, WE}, Noble WS. Static Models Improve Percolator
  ...
  %\item \textbf{Fondrie WE}, Zelter A, Henry E, Abel S, Le Roch KG, Davis TN, Noble
...
\begin{tabular}{\tdim}
  ...
  2019--21  & \textbf{Kianna Hales}, PhD student\newline Department of Genome Sciences, University of Washington\\
...
\textbf{Journal Referee: }\textit{Scientific Reports, Journal of Proteome Research}\\
