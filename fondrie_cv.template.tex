...
\pagestyle{fancy}
\fancyhf{}
\rhead{\textbf{William E Fondrie}}
\lhead{\textbf{Curriculum Vitae}}
\rfoot{\thepage}
...
{% if preprints %}
\mysection{Preprints}
\newline {\small (* indicates equal contributions)}
\begin{etaremune}
{{ preprints }}
\end{etaremune}
{% endif %}
...
\mysection{Grants}
\begin{etaremune}
  \item \textbf{Deployment of an AI platform to accelerate transcription factor drug development.} \\
  Funder: NCATS 1R44TR005930-01A1 \\
  Amount: \$2,094,653\\
  Period: 2026--2028 \\
  Role: PI \\
...
\begin{tabular}{\tdim}
  ...
  2024 \newline 2026 & Machine Learning for Proteomics Data Analysis. US Hupo 1-day short course. \\
